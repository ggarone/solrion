...
/**
 * Small, explicit validation helpers used across DSL, request models and mappers. Keep it boring
 * and consistent: validate at the boundary (builders, client methods).
 */
