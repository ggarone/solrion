...
public final class SolrParamsMapper {
  ...
  public ParamBag toSelectParams(SelectRequest req) {
    ...
    if (req.pagination() != null) {
      if (req.pagination().start() != null) {
        p.add("request", String.valueOf(req.pagination().start()));
      }
      if (req.pagination().rows() != null) {
        p.add("rows", String.valueOf(req.pagination().rows()));
      }
    }
  ...
  public ParamBag toUpdateOptions(UpdateOptions opt) {
    ...
    if (opt.commit() != null) {
      p.add("commit", String.valueOf(opt.commit()));
    } else if (opt.softCommit() != null) {
      p.add("softcommit", String.valueOf(opt.softCommit()));
    } else if (opt.commitWithinMs() != null) {
      p.add("commitWithinMs", String.valueOf(opt.commitWithinMs()));
    }
    if (opt.overwrite() != null) {
      p.add("overwrite", String.valueOf(opt.overwrite()));
    }
    if (opt.expungeDeletes() != null) {
      p.add("expungeDeletes", String.valueOf(opt.expungeDeletes()));
    }
    if (opt.waitSearcher() != null) {
      p.add("waitSearcher", String.valueOf(opt.waitSearcher()));
    }
    if (opt.openSearcher() != null) {
      p.add("openSearcher", String.valueOf(opt.openSearcher()));
    }
