...
public final class RequestBuilders {
  ...
  public static final class DeleteByIdRequestBuilder
      extends UpdateRequestBuilder<DeleteByIdRequestBuilder> {
  ...
  public static final class DeleteByQueryRequestBuilder
      extends UpdateRequestBuilder<DeleteByQueryRequestBuilder> {
  ...
  public static final class CommitRequestBuilder
      extends UpdateRequestBuilder<CommitRequestBuilder> {
