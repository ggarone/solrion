 ...
 *
 * <p>Exactly one grouping target must be provided.
 */
public record GroupingSpec(
  ...
  public GroupingSpec {
    ...
    if (limit != null) {
      Validate.require(limit >= 0, "limit must be >= 0");
    }
    if (offset != null) {
  ...
  public static GroupingSpec disabled() {
    return new GroupingSpec(
        false, null, null, null, null, GroupingFormat.GROUPED, null, null, Map.of());
  }
}
