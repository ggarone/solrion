...
public class StatsField {
  ...
  @Builder
  public StatsField(
      String field, List<Integer> percentiles, Boolean calcDistinct, Expr.LocalParams localParams) {
    if (percentiles != null) {
      percentiles.forEach(
          p -> Validate.require(p > 0 && p < 100, "percentile must be between 1 and 99"));
    }
